...
export function DeactivateDevice(arg1) {
  return window['go']['main']['App']['DeactivateDevice'](arg1);
}
...
export function RecoverLicense(arg1) {
  return window['go']['main']['App']['RecoverLicense'](arg1);
}
